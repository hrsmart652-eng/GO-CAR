...
import '../cubit/normal_ride_state.dart';

class SearchLocationAndDestination extends StatelessWidget {
  SearchLocationAndDestination({super.key,required this.isCurrentLocation});
              ...
              children: [
                ...
                Positioned(
                  ...
                  child:IconButton(
                    ...
                    onPressed: () {
                      normalCubit.clearLocation(
                        constroller: isCurrentLocation
                            ? normalCubit.currentLocationCon
                            : normalCubit.destinationCon,
                      );
                    },
                    ...
                    child: CustomTextFieldValidator(
                      ...
                      onChanged: (location) {
                        isCurrentLocation == true
                            ? normalCubit.setCurrentLocation(
