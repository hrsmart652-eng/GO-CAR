...
class SchdulePaymentScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ScheduledRideCubit, ScheduledRideState>(
      ...
      builder: (context, state) {
        ...
        final isCash = cubit.paymentMethod == 'cash';
        final isCredit = cubit.paymentMethod == 'credit';
        final isLoading = state is ScheduledRideLoading;
                ...
                children: [
                  ...
                  isLoading
                    ...
                    onPressed: () async {
                      ...
                      if (isCredit && cubit.selectedVisaCard == null) {
                        showSnackBar(
                          context,
                      ...
                      cubit.isSchdule = true;
                      if (context.mounted) {
                        Navigator.pushNamed(
                          context,
                          Routes.requestSendScreen,
                        );
                      }
                    },
                  ),
