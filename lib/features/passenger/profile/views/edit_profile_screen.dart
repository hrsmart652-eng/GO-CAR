...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    ...
    if (cubit.state is ClientProfileSuccess) {
      final profile = (cubit.state as ClientProfileSuccess);

      nameController.text = profile.clientModel.fullName ?? '';
      phoneController.text = profile.clientModel.phoneNumber ?? '';
    }
  }
                            ...
                            child: CircleAvatar(
                              ...
                              backgroundImage:
                                  state.clientModel.image == null
                                      ...
                                      : NetworkImage(state.clientModel.image),
                            ),
                          ),
